...
tests_summary = ns.model(
    "tests_summary",
    {
        "passed_count": fields.Integer(
            attribute="br_total_passed_count",
            description="Total number of tests that passed in this build.",
        ),
        "failed_count": fields.Integer(
            attribute="br_total_failed_count",
            description="Total number of tests that failed in this build.",
        ),
        "skipped_count": fields.Integer(
            attribute="br_total_skipped_count",
...
build_model = ns.model(
    "build",
    {
        "platform": fields.String(
            attribute="br_platform", description="Platform this build executed on."
        ),
        "job_name": fields.String(
            attribute="br_job_name", description="Job this build belongs to."
        ),
        "build_date_time": fields.DateTime(
            attribute="br_build_date_time",
            dt_format=u"iso8601",
        ...
        "status_key": fields.String(
            attribute="br_status_key", description="Status of the whole build."
        ),
...
test_model = ns.model(
    "test",
    {
        ...
        "report_set": fields.String(
            attribute="br_reportset", description="Report set the test belongs to."
        ),
    },
)
